...
** 3d tetris status
- Tried all the hard ways, finally it is working now (emacs is not working, computer refuse to work too). Don't have efficient in the evening. Check in and will clean code tomorrow. 
