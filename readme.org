...
- OpenGL 3D version status: 
  - Takes way too long for Gc, need to look into it and think about it. 
  - Will work on DorkyMonkey for some hours, and come back here. 
  ...
  - Will update DorkyMonkeyrepository tonight. 
  - 
