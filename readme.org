...
- Understand how do vertex and fragment shaders work. Since vertex shader has done pretty much all the computation work for matrix transformation, I need to think why I need self define shaders and transformation matrix, for what use propose if I do need to implement them for customization.
