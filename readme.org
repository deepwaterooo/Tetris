...
*** Status Update
- On the texture part for 3d, the program is almost through and ok, except that I have to figure out texture pixel formats, RGBA_8888, RGBA565 etc for (RGB 128*128 pixesl).
-
