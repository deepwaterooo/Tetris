...
** 3d tetris status
- GLES20 rendering flow through, will get frame, some cubes, blocks ready in the evening, and try implement rotation for later on use as I had tried using wrong approach about two to three weeks ago. 
