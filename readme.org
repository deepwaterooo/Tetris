...
- OpenGL 3D version status: 
  - I think I understand all the theories now, but for drawing grids correctly, something are still wrong. Will work on it this weekend, and problem will be solved by coming Monday. Checkpoints include:
    ...
    - the later several parameters.

       #+BEGIN_SRC java
Matrix.frustumM(mProjectionMatrix, 0, -ratio, ratio, -1, 1, 3, 7);
       #+END_SRC
    - check each cube center compares against world center.
    - check eye position for translation: 
