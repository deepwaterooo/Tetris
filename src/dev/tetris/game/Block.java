...
public class Block implements Serializable {
	...
	public enum BlockColor {
		RED(0xffff0000, (byte) 2),
        GREEN(0xff00ff00, (byte) 3),
        BLUE(0xff0000ff, (byte) 4),
        YELLOW(0xffffff00, (byte) 5),
        CYAN(0xff00ffff, (byte) 6);
        //LTGREY(0xffcccccc, (byte) 7),
        //MAGENTA(0xffff00ff, (byte) 8);
	...
	private int shape = 0;
	private int frame = 0;
	private Point topLeft = new Point( Model.NUM_COLS / 2, 0); // (5, 0)
	...
	private enum Shape {
		...
		public abstract Frame getFrame(int n);  // define the method
	}
