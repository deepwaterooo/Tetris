...
public class StarRenderer implements GLSurfaceView.Renderer {
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        //cube = new Cube(StarRenderer.this);
    ...
    public void onSurfaceChanged(GL10 gl, int w, int h) {
        ...
        MatrixState.setCamera(4.2f, 2.2f, 2.0f, 0, 0, 0, 0, 1.0f, 0f);
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        // 设置沿Z轴正向位移1
		//Matrix.translateM(mMVPMatrix, 0, -3f, -7f, -3f);
        ...
        for (int i = 6; i < Model.ROW; i++) 
            for (int j = 6; j < Model.COL; j++) 
                model.board[i][j][0] = 1;
        /*
        Matrix.setLookAtM(mViewMatrix, 0, 4.2f, 2.2f, 2.0f,
                          3f, 0, 3f,  
                          0f, 1.0f, 0.0f); // good
        Matrix.multiplyMM(mMVPMatrix, 0, mProjectionMatrix, 0, mViewMatrix, 0); 
        GLES20.glUseProgram(mProgram);
        */
        ...
        MatrixState.translate(0.68571f, 0f, 0.571425f);
        drawGameCell();
        MatrixState.popMatrix();
...
private void drawGameFrame() {
        ...
        /*            
            ...
            -0.34286f,  -1.028565f, -0.8f, -0.34286f,  -1.028565f, 0.8f, 
            -0.11428f, -1.028565f, -0.8f, -0.11428f, -1.028565f, 0.8f,
            0.11429f, -1.028565f, -0.8f, 0.11429f, -1.028565f, 0.8f,
            0.34286f,  -1.028565f, -0.8f, 0.34286f,  -1.028565f, 0.8f, 
            0.57143f, -1.028565f, -0.8f, 0.57143f,  -1.028565f, 0.8f,
