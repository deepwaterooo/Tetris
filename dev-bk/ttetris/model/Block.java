...
public class Block implements Cloneable, Serializable {
    private static final long serialVersionUID = 5488732457850551759L;
    ...
    static {
        createMetaBlock("Square", CubeType.Anchient, BlockCubeShifts.squareShifts, 0.5F, 0.5F, 0.0F);
        createMetaBlock("Line", CubeType.Amethyst, BlockCubeShifts.lineShifts, 0.0F, 1.0F, 0.0F);
        createMetaBlock("LeftLightning", CubeType.Oak, BlockCubeShifts.leftLightningShifts, 1.0F, 1.0F, 0.0F);
        createMetaBlock("RightLightning", CubeType.MarbleRough, BlockCubeShifts.rightLightningShifts, 1.0F, 1.0F, 0.0F);
        createMetaBlock("Roof", CubeType.LapisLazuli, BlockCubeShifts.roofShifts, 0.0F, 0.0F, 0.0F);
        createMetaBlock("LeftBoot", CubeType.WhiteMarble, BlockCubeShifts.leftBootShifts, 1.0F, 1.0F, 0.0F);
        createMetaBlock("RightBoot", CubeType.Marble, BlockCubeShifts.rightBootShifts, 0.0F, 1.0F, 0.0F);
    }
    ...
    private static void createMetaBlock(String paramString, CubeType paramCubeType, CubeShift[] paramArrayOfCubeShift,
                                        float paramFloat1, float paramFloat2, float paramFloat3) {
        blocks.put(paramString, new BlockMeta(paramCubeType, paramArrayOfCubeShift, paramFloat1, paramFloat2, paramFloat3));
    }
    ...
    private Block(BlockMeta paramBlockMeta) {
        ...
        for (int m = 0; ; m++) {
            ...
            this.cubes[m] = new Cube(paramBlockMeta.getType(),
