...
public class TTetris extends Activity implements OnClickListener {
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_ttetris);
    ...
    public void onClick(View v) {
        ...
        case R.id.mara_button:
            Intent m = new Intent(this, ActivityGame.class);
            startActivity(m);
            break;
        case R.id.time_button:
            Intent t = new Intent(this, ActivityGame.class);
            startActivity(t);
            break;
        case R.id.toy_button:
            Intent to = new Intent(this, ActivityGame.class);
            startActivity(to);
            break;
        case R.id.score_button:
            Intent s = new Intent(this, ActivityGame.class);
            startActivity(s);
            break;
