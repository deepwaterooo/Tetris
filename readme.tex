...
\label{sec-1-1-2}
\begin{itemize}
\item Restructureing the project for OOP better organization, it was such a headache maitain all the shaders all the times for frame, grid, cutes etc, especially when I used textures and needs both color shader and texture shaders.
\item Project structure is still supposed to change according to feature needs when I get more and more into implementation details.
\item Minor bugs will be fixed for cube texCoords, and for board rendering for cubes.
\item 
...
\includegraphics[width=.9\linewidth]{./pic/Screenshot_2016-05-23-16-15-19.png}
