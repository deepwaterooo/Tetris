...
\label{sec-1-1}
\begin{itemize}
\item Tried all the hard ways, finally it is working now (emacs is not working, computer refuse to work too). Don't have efficient in the evening. Check in and will clean code tomorrow.
...
\includegraphics[width=.9\linewidth]{./pic/Screenshot_2016-05-11-13-00-34.png}
