...
\begin{itemize}
\item I think I understand all the theories now, but for drawing grids correctly, something are still wrong. Will work on it this weekend, and hopefully problem will be solved by coming Monday. 
\begin{itemize}
