...
public final class BlockType {
    ...
    static {
        ...
        arrayOfCube1[0] = new Cube(1, -1, 0, -1);
        arrayOfCube1[1] = new Cube(1, -1, 0, 1);
        arrayOfCube1[2] = new Cube(1, 1, 0, 1);
        arrayOfCube1[3] = new Cube(1, 1, 0, -1);
        squareType = arrayOfCube1; // Ìï, red
        
        Cube[] arrayOfCube2 = new Cube[4];
        arrayOfCube2[0] = new Cube(2, 0, 0, -2);
        arrayOfCube2[1] = new Cube(2, 0, 0, -1);
        arrayOfCube2[2] = new Cube(2, 0, 0, 0);
        arrayOfCube2[3] = new Cube(2, 0, 0, 1);
        lineType = arrayOfCube2;   // I, green
        
        Cube[] arrayOfCube3 = new Cube[4];
        arrayOfCube3[0] = new Cube(3, 0, 0, 0);
        arrayOfCube3[1] = new Cube(3, 0, 0, 1);
        arrayOfCube3[2] = new Cube(3, 1, 0, 1);
        arrayOfCube3[3] = new Cube(3, 1, 0, 2);
        leftLightningType = arrayOfCube3; // 3
        
        Cube[] arrayOfCube4 = new Cube[4];
        arrayOfCube4[0] = new Cube(4, 1, 0, 0);
        arrayOfCube4[1] = new Cube(4, 1, 0, 1);
        arrayOfCube4[2] = new Cube(4, 0, 0, 1);
        arrayOfCube4[3] = new Cube(4, 0, 0, 2);
