...
public class Vector3f {
	...
	public void set(Vector3f v) { set(v.x, v.y, v.z); }
	...
	public final float dot(Vector3f v1) { return (this.x * v1.x + this.y * v1.y + this.z * v1.z); }

	public final void cross(Vector3f v1, Vector3f v2) {
		/*float x, y;
		x = v1.y * v2.z - v1.z * v2.y;      // x
        y = v1.z * v2.x - v1.x * v2.z; */   // y
		this.x = v1.y * v2.z - v1.z * v2.y;      // x
		this.y = v1.z * v2.x - v1.x * v2.z;      // y
		this.z = v1.x * v2.y - v1.y * v2.x; // z
	}
