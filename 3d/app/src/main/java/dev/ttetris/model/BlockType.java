...
import dev.ttetris.model.CubeShift;
...
public final class BlockType {
    ...
    static {
        ...
        squareType = arrayOfCubeShift1; // Ìï, red, (.5, .5, 0)
        
        CubeShift[] arrayOfCubeShift2 = new CubeShift[4];
        arrayOfCubeShift2[0] = new CubeShift(0, -1, 0);
        arrayOfCubeShift2[1] = new CubeShift(0, 0, 0);
        arrayOfCubeShift2[2] = new CubeShift(0, 1, 0);
        arrayOfCubeShift2[3] = new CubeShift(0, 2, 0);
        lineType = arrayOfCubeShift2;   // I, yellow (0, .5, 0)
        ...
        leftLightningType = arrayOfCubeShift3; // 3 (.5, 1, 0)
        ...
        rightLightningType = arrayOfCubeShift4; // 4 (.5, 1, 0)
        ...
        roofType = arrayOfCubeShift5;           // 5 (0, .5, 0)
        ...
        leftBootType = arrayOfCubeShift6;       // 6 (.5, 1, 0)
