...
public final class BlockType {
    ...
    static {
        ...
        arrayOfCube2[0] = new Cube(2, 0, 0, 0);
        arrayOfCube2[1] = new Cube(2, 0, 1, 0);
        arrayOfCube2[2] = new Cube(2, 0, 2, 0);
        arrayOfCube2[3] = new Cube(2, 0, 3, 0);
        lineType = arrayOfCube2;   // I, yellow
