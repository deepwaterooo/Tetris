...
void main() {
    ...
    vec4 envColor = textureCube(sEnvMap, reflect(-viewDirectionInv, normal));
	...
	vec4 envRefl = uReflectionStrength * envColor;

	gl_FragColor = ambient + diffuse + specular + envRefl;
}
