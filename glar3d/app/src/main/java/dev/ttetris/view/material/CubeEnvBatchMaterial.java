...
public class CubeEnvBatchMaterial extends Material
    implements CubeBatch {
    ...
    public CubeEnvBatchMaterial(AssetManager paramAssetManager, String paramString) {
        super(paramAssetManager.getShader("Shaders/CubeEnvBatch.glsl"));
